  ...
  return (
    <div className="w-full pt-32 pb-24 px-6 bg-sand">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Form */}
        <div className="bg-white/60 p-8 md:p-12 rounded-sm border border-sand-dark shadow-sm min-h-[400px] flex flex-col justify-center">
          {isSubmitted ? (
            <motion.div 
            ...
            >
              <div className="text-honey flex justify-center">
                <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <h2 className="text-3xl font-serif text-ocean-dark">Thank you so much!</h2>
              <p className="text-lg text-charcoal/80 font-light leading-relaxed">
                We’ve received your application and will get back to you soon.<br />
                <span className="italic mt-4 block text-ocean-dark/70">With love Anna and Natalia</span>
              </p>
              <div className="pt-8">
                <Button 
            ...
            <form className="space-y-8" onSubmit={handleSubmit}>
              ...
              <div className="pt-6">
                <Button 
                  ...
                  className="w-full bg-ocean-dark text-sand hover:bg-sand-dark hover:text-ocean-dark uppercase tracking-widest text-sm disabled:opacity-50"
                >
